...
/**
 * Renders the application's collapsible sidebar with primary navigation, a CRM submenu, organization switching, and user account controls.
 *
 * The sidebar adapts its layout when collapsed, highlights active routes based on the current pathname, and opens the CRM section by default for `/crm` routes. CRM submenu items expose a context menu that can open an item in a new tab or copy its full URL to the clipboard.
 *
