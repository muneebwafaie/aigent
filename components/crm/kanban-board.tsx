...
/**
 * Render a Kanban board of opportunities with drag-and-drop reordering and optimistic local updates.
 *
 * Renders columns for each stage and opportunity cards for items in those stages, supports pointer and keyboard dragging,
 * visual drag overlay, and temporary local reordering while a drag is active.
 *
 * @param stages - Ordered list of stage names displayed as columns
 * @param opportunities - Array of opportunities to display; each opportunity's `stageIndex` determines its column
 * @param onMoveOpp - Called when an opportunity is dropped into a different stage; receives the opportunity id and the new stage index
 * @param onOppClick - Callback invoked when an opportunity card is clicked
 * @param onDeleteOpp - Callback invoked to delete an opportunity
 * @param onEditOpp - Callback invoked to edit an opportunity
 * @param pendingOpportunityIds - Optional set of opportunity ids currently pending server-side changes; used to render pending state
 * @returns The rendered Kanban board React element
 */
